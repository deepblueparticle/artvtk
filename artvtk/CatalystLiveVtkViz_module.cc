...
class artvtk::CatalystLiveVtkViz : public art::EDAnalyzer {
public:
...
artvtk::CatalystLiveVtkViz::CatalystLiveVtkViz(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p),
...
void artvtk::CatalystLiveVtkViz::analyze(art::Event const & e)
{
...
DEFINE_ART_MODULE(artvtk::CatalystLiveVtkViz)
