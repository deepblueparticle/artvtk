...
class artvtk::ShowVtkVizObjectsInEvent : public art::EDAnalyzer {
public:
...
artvtk::ShowVtkVizObjectsInEvent::ShowVtkVizObjectsInEvent(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p)  // ,
 // More initializers here.
{}

void artvtk::ShowVtkVizObjectsInEvent::analyze(art::Event const & e)
{
...
DEFINE_ART_MODULE(artvtk::ShowVtkVizObjectsInEvent)
