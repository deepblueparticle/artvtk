...
class artvtk::Cone : public art::EDProducer {
public:
...
artvtk::Cone::Cone(fhicl::ParameterSet const & p) :
...
void artvtk::Cone::produce(art::Event & e)
{
...
vtkSmartPointer<vtkPolyData> artvtk::Cone::makeConeGrid() {
